 ...
 * @author geoagdt
 */
public class Census_Age_EcoAct_LSOA_DataRecord {
     ...
     * @param RecordID
     */
    public Census_Age_EcoAct_LSOA_DataRecord(
            long RecordID) {
    ...
    public Census_Age_EcoAct_LSOA_DataRecord(
            long RecordID,
            String line,
            Census_Age_EcoAct_LSOA_DataRecord_Handler handler) throws Exception {
        this.RecordID = RecordID;
