...
public class Census_CAS001DataHandler extends Census_AbstractDataHandler {
    ...
    public Census_CAS001DataHandler() {
        ...
        try {
            ...
            this._RecordLength = new Census_CAS001DataRecord().getSizeInBytes();
    ...
    protected long format(
        ...
        try {
            BufferedReader br;
            br = env.io.getBufferedReader(_File);
...
//                    new FileInputStream(sourceFile)));
            ...
            while (tokenType != StreamTokenizer.TT_EOF) {
                switch (tokenType) {
                    ...
                    case StreamTokenizer.TT_WORD:
                        ...
                        aCAS001DataRecord = new Census_CAS001DataRecord(RecordID, line);
                        break;
                }
                tokenType = aStreamTokenizer.nextToken();
            }
     ...
     * @param RecordID
     *            The RecordID of the Census_CAS001DataRecord to be returned.
     */
    @Override
    ...
    public Census_CAS001DataRecord getCAS001DataRecord(long RecordID) {
        ...
        try {
            ...
            result = new Census_CAS001DataRecord(this._RandomAccessFile);
        } catch (IOException aIOException) {
            log(aIOException.getLocalizedMessage());
            System.exit(Generic_ErrorAndExceptionHandler.IOException);
        }
