 ...
 *
 */
public class Census_SWSDataRecord extends Census_AbstractDataRecord {
    ...
    public Census_SWSDataRecord(boolean initZero) {
        initZero();
    }
     ...
     */
    protected void init(Census_SWSDataRecord a_SWSDataRecord) {
