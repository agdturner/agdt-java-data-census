...
import uk.ac.leeds.ccg.andyt.math.Math_Boolean;
...
//            return false;
//        }
        this._AGEH = Math_Short.parseShort(fields[4]);
        if (_AGEH == -9) {
            return false;
        }
        ...
        this._PNUM = Math_Short.parseShort(fields[1]);
        this._ID = Math_Long.parseLong(fields[2]);
        this._ACCTYPE = Math_Short.parseShort(fields[3]);
        this._BATHWC = Math_Short.parseShort(fields[5]);
        this._CARSH = Math_Short.parseShort(fields[6]);
        this._CENHEAT0 = Math_Short.parseShort(fields[7]);
        this._COBIRT0 = Math_Short.parseShort(fields[8]);
        this._DENSITY = Math_Short.parseShort(fields[9]);
        this._DISTMOV0 = Math_Short.parseShort(fields[10]);
        this._DISTWRK0 = Math_Short.parseShort(fields[11]);
        this._ECONACH = Math_Short.parseShort(fields[12]);
        this._EDISDONO = Math_Short.parseShort(fields[13]);
        this._ETHEW = Math_Short.parseShort(fields[14]);
        this._EVERWORK = Math_Short.parseShort(fields[15]);
        this._FAMNUMB = Math_Short.parseShort(fields[16]);
        this._FAMTYP = Math_Short.parseShort(fields[17]);
        this._FRP = Math_Short.parseShort(fields[18]);
        this._GENIND = Math_Short.parseShort(fields[19]);
        this._HEALTH = Math_Short.parseShort(fields[20]);
        this._HEDIND = Math_Short.parseShort(fields[21]);
        this._HEDISDON = Math_Boolean.parseBoolean(fields[22]);
        this._HEMPIND = Math_Short.parseShort(fields[23]);
        this._HHLTHIND = Math_Short.parseShort(fields[24]);
        this._HHSGIND = Math_Short.parseShort(fields[25]);
        this._HMIGIND = Math_Short.parseShort(fields[26]);
        this._HNRESIDN = Math_Short.parseShort(fields[27]);
        this._HOURSPW = Math_Short.parseShort(fields[28]);
        this._HRSOCGRD = Math_Short.parseShort(fields[30]);
        this._INDSTRY0 = Math_Short.parseShort(fields[31]);
        this._ISCO3 = Integer.valueOf(fields[32]);
        this._LASTWORK = Math_Short.parseShort(fields[33]);
        this._LLTI = Math_Short.parseShort(fields[34]);
        this._LOWFLOR0 = Math_Short.parseShort(fields[35]);
        this._MARSTAH = Math_Short.parseShort(fields[36]);
        this._MIGIND = Math_Short.parseShort(fields[37]);
        this._NSSEC = Math_Short.parseShort(fields[38]);
        this._ONCPERIM = Math_Short.parseShort(fields[39]);
        this._POPBASE = Math_Short.parseShort(fields[40]);
        this._PROFQUAL = Math_Short.parseShort(fields[41]);
        this._PROVCARE = Math_Short.parseShort(fields[42]);
        this._QUALVEWN = Math_Short.parseShort(fields[43]);
        this._RELGEW = Math_Short.parseShort(fields[44]);
        this._RELTOHR = Math_Short.parseShort(fields[45]);
        this._ROOMREQ = Math_Short.parseShort(fields[46]);
        this._ROOMSNMH = Math_Short.parseShort(fields[47]);
        this._SELFCONT = Math_Boolean.parseBoolean(fields[48]);
        this._SOCMIN = Math_Integer.parseInt(fields[50]);
        this._STAHUKH = Math_Short.parseShort(fields[51]);
        this._STAPUK = Math_Short.parseShort(fields[52]);
        this._STUDENT = Math_Boolean.parseBoolean(fields[53]);
        this._SUPERVSR = Math_Short.parseShort(fields[54]);
        this._TERMTIME = Math_Short.parseShort(fields[56]);
        this._TRANWRK0 = Math_Short.parseShort(fields[57]);
        this._WORKFORC = Math_Short.parseShort(fields[58]);
        this._WRKPLCE0 = Math_Short.parseShort(fields[59]);
        return true;
    }
