 ...
 */
public class Census_CASKS017DataRecord extends Census_AbstractDataRecord {
     ...
     */
    public Census_CASKS017DataRecord(Census_CASKS017DataRecord aCASKS017Record) {
     ...
     */
    public Census_CASKS017DataRecord(long RecordID, String line) throws IOException {
     ...
     */
    protected void init(Census_CASKS017DataRecord cASKS017Record) {
    ...
    /**
     * @return An aggregated <code>Census_CASKS017DataRecord</code> where:
     ...
     *            The <code>Census_CASKS017DataRecord</code> to be aggregated with
     *            <code>this</code>.
     */
    public Census_CASKS017DataRecord aggregate(Census_CASKS017DataRecord aCASKS017DataRecord) {
        Census_CASKS017DataRecord newCASKS017DataRecord = new Census_CASKS017DataRecord(
                aCASKS017DataRecord);
