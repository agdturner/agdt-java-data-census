 ...
 */
public class Census_CASDataHandler extends Census_AbstractHandler {
     ...
     */
    public Census_CASDataHandler(Census_Environment e) throws IOException {
        super (e);
    }
...
//            aggregation = "";
//        }
//        this.CAS001Handler = new Census_CAS001Handler(new File(
...
//    }
    ...
    // /**
    // * Returns this.CAS001Handler
    // */
    // public Census_CAS001Handler getCAS001DataHandler() {
    // return this.CAS001Handler;
    // }
    /**
...
//        CAS001Handler.aggregateOAToWard(aRandomAccessFile, startRecordID,
//                endRecordID);
//        aRandomAccessFile.close();
//        CAS001Handler = new Census_CAS001Handler(getEnv());
//        nDataRecords = CAS001Handler.getNDataRecords();
...
//            aCAS001DataRecord = CAS001Handler.getCAS001DataRecord(along);
...
//        aFile.createNewFile();
//        aRandomAccessFile = new RandomAccessFile(aFile, "rw");
//        CAS003Handler.aggregateOAToWard(aRandomAccessFile, startRecordID,
//                endRecordID);
//        aRandomAccessFile.close();
//        CAS003Handler = new Census_CAS003DataHandler(aFile);
//        nDataRecords = CAS003Handler.getNDataRecords();
//        System.out.println("nDataRecords " + nDataRecords);
...
//        for (along = 0L; along < nDataRecords; along++) {
//            aCAS003DataRecord = CAS003Handler.getCAS003DataRecord(along);
...
//        aFile.createNewFile();
//        aRandomAccessFile = new RandomAccessFile(aFile, "rw");
//        CAS001Handler.aggregateOAToMSOA(aRandomAccessFile, startRecordID,
//                endRecordID);
//        aRandomAccessFile.close();
//        CAS001Handler = new Census_CAS001Handler(aFile);
//        nDataRecords = CAS001Handler.getNDataRecords();
//        Census_CAS001DataRecord aCAS001DataRecord = new Census_CAS001DataRecord();
//        aFile = new File(dir,
...
//        aFile.createNewFile();
//        aRandomAccessFile = new RandomAccessFile(aFile, "rw");
//        CAS003Handler.aggregateOAToMSOA(aRandomAccessFile, startRecordID,
//                endRecordID);
//        aRandomAccessFile.close();
//        CAS003Handler = new Census_CAS003DataHandler(aFile);
//        nDataRecords = CAS003Handler.getNDataRecords();
...
//        aPrintWriter.close();
    ...
    public long getNDataRecords() throws IOException {
        return this.CAS001Handler.getNDataRecords();
    }
}
